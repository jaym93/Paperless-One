...
/**
 * Servlet implementation class ProblemService
 */
@WebServlet("/ProblemService")
public class ProblemService extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ProblemPageProcess process = new ProblemPageProcess();
			prob =process.getProbs();
