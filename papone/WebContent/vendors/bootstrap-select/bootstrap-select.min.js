...
! function(a) {
    ...
    f.VERSION = "1.6.3", f.DEFAULTS = {
        ...
        init: function() {
            ...
            this.$element.hide(), this.multiple = this.$element.prop("multiple"), this.$newElement = this.createView(), this.$element.after(this.$newElement), this.$menu = this.$newElement.find("> .dropdown-menu"), this.$button = this.$newElement.find("> button"), this.$searchbox = this.$newElement.find("input"), this.options.dropdownAlignRight && this.$menu.addClass("dropdown-menu-right"), "undefined" != typeof c && (this.$button.attr("data-id", c), a('label[for="' + c + '"]').click(function(a) {
        ...
        createDropdown: function() {
            var b = this.multiple ? " show-tick" : "",
                ...
                g = this.options.liveSearch ? '<div class="bs-searchbox"><input type="text" class="input-block-level form-control" autocomplete="on" placeholder="Search" /></div>' : "",
        ...
        liHeight: function() {
            if (this.options.size !== !1) {
                var a = this.$menu.parent().clone().find("> .dropdown-toggle").prop("aut", !1).end().appendTo("body"),
