...
ColVis.prototype = {
	...
	"_fnConstruct": function ( init )
	{
		...
		this.dom.button = $( '<button class="btn bgm-cyan waves-effect waves-button" style="border-radius:5px; margin:3px 10px;"/>', {
	...
	"_fnDomGroupButton": function ( i )
	{
		...
		return $(
				'<li class="ColVis_Special ' + (dt.bJUI ? 'ui-button ui-state-default' : '') + '">' +
                    '<div class="checkbox">' +
					    '<label style="font-weight:400; font-sixe:18px;" class="dropdown-item" aria-disabled="false">'+
						    '<input type="checkbox" class="dropdown-item-checkbox" />' +
