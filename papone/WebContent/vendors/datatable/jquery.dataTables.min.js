    ...
    var P = function (h) {
        ...
        function ob(a) {
            var b = a.oClasses,
                ...
                d = a.oPreviousSearch,
                f = a.aanFeatures,
                g = '<input type="search" class="' + b.sFilterInput + ' search-table" /> ',
                j = e.sSearch,
                j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g,
                b = h("<div/>", {
                    id: !f.f ? c + "_filter" : null,
                    "class": b.sFilter
                }).append(h("<label style='width:90%'/>").append(j)),
                f = function () {
        ...
        function nb(a) {
            for (var b = a.oClasses, c = a.sTableId, e = a.aLengthMenu, d = h.isArray(e[0]), f = d ? e[0] : e, e = d ? e[1] : e, d = h("<select class='selectpicker' style='width:60%'/>", {
                name: c + "_length",
                    "aria-controls": c,
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                oPaginate: {
                    sFirst: "<i class='md md-skip-previous'/>",
                    sLast: "<i class='md md-skip-next'/>",
                    sNext: "<i class='md md-chevron-right'/>",
                    sPrevious: "<i class='md md-chevron-left'/>"
                },
                ...
                sDecimal: "",
                sThousands: ",",
                sLengthMenu: "<i class='md md-toc' style='font-size:25px;'>&nbsp;</i>_MENU_",
                sLoadingRecords: "Loading...",
                sProcessing: "Processing...",
                sSearch: "<i class='md md-search' style='font-size:20px;'>&nbsp;</i>",
                sSearchPlaceholder: "",
                sUrl: "",
        ...
        h.extend(m.ext.classes, {
            sTable: "dataTable",
            sNoFooter: "",
            sPageButton: "paginate_button button",
                        ...
                        m = function (b, e) {
                            ...
                            for (r = e.length; n < r; n++) {
                                ...
                                if (h.isArray(s)) {
                                    ...
                                    if (i) {
                                        t = h("<a>", {
                                            "class": g.sPageButton + " waves-effect " + k,
