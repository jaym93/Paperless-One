! function (e, t) {
    ...
    function n() {
        function n(t) {
            ...
            if (-1 !== [9, 13, 32, 27].indexOf(o)) {
                ...
                9 === o ? (a = -1 === r ? k : r === x.length - 1 ? x[0] : x[r + 1], H(n), l(a)) : 13 === o || 32 === o ? -1 === r && I(k, n) : 27 === o && u.allowEscapeKey === !0 && I(B, n)
            }
        }
            ...
            switch (n.type) {
                ...
                case "click":
                    if (r && u.callback && i) u.callback(!0), u.closeOnConfirm && s();
                        ...
                        d && u.callback(!1), u.closeOnCancel && s()
                    } else s()
            }
        },
        ...
        m = e.onkeydown, e.onkeydown = n, k.style.borderLeftColor = u.confirmButtonColor, k.style.borderRightColor = u.confirmButtonColor, e.swal.toggleLoading = function () {
    ...
    function o(n) {
        ...
        if (l.innerHTML = x(n.title).split("\n").join("<br>"), i.innerHTML = x(n.text.split("\n").join("<br>")) || n.html, i.innerHTML && E(i), n.customClass && k(o, n.customClass), q(o.querySelectorAll(".icon")), n.type) {
            for (var d = !1, m = 0; m < v.length; m++)
                if (n.type === v[m]) {
                    d = !0;
                    break
                }
            if (!d) return e.console.error("Unknown alert type: " + n.type), !1;
    ...
    function s() {
        ...
        B(r, "pulse-warning"), B(r.querySelector(".body"), "pulse-warning-ins"), B(r.querySelector(".dot"), "pulse-warning-ins"), e.onkeydown = m, t.onclick = d, u && u.focus(), f = void 0, clearTimeout(n.timeout);
    ...
    e.sweetAlert = e.swal = function () {
        ...
        var e = '<div class="sweet-overlay" tabIndex="-1"></div><div class="sweet-alert" tabIndex="-1"><div class="icon error"><span class="x-mark"><span class="line left"></span><span class="line right"></span></span></div><div class="icon warning"> <span class="body"></span> <span class="dot"></span> </div> <div class="icon info"></div> <div class="icon success"> <span class="line tip"></span> <span class="line long"></span> <div class="placeholder"></div> <div class="fix"></div> </div> <div class="icon custom"></div> <h2>Title</h2><p>Text</p><button class="confirm waves-effect bgm-indigo" style="padding:10px 30px;">OK</button><button class="cancel waves-effect bgm-red" style="padding:10px 30px;">Cancel</button></div>',
